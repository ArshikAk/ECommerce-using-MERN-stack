...
const Wishlist = () => {
  ...
  useEffect(() => {
    axios
      .get("httpa://exclusiveserver-xr6s7fded-arshiks-projects.vercel.app/api/wishlist/getWishList", config)
      .then((response) => {
  ...
  const addToCart = () => {
    axios.post("httpa://exclusiveserver-xr6s7fded-arshiks-projects.vercel.app/api/cart/addToCart",{items},config)
    .then((result) => {
