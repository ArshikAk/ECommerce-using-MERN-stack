...
const Account = () => {
  ...
  useEffect(() => {
    axios.get("httpa://exclusiveserver-xr6s7fded-arshiks-projects.vercel.app/api/account/getProfile",config)
    .then((result) => {
  ...
  const saveChanges = () => {
    if(validator())
    {
      axios.put("httpa://exclusiveserver-xr6s7fded-arshiks-projects.vercel.app/api/account/updateProfile",{name,email,changePassword,newPassword,currentPassword},config)
      .then((result) => {
