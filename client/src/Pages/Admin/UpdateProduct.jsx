...
const UpdateProduct = () => {
  ...
  useEffect(() => {
    axios.get(`httpa://exclusiveserver-xr6s7fded-arshiks-projects.vercel.app/api/product/getProducts/${id}`)
    .then((result) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      axios.put("httpa://exclusiveserver-xr6s7fded-arshiks-projects.vercel.app/api/admin/updateProduct",{product},config)
      .then((result) => {
