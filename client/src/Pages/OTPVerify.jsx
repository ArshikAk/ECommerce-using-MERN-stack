...
const OTPVerify = () => {
  ...
  const submitHandler1 = () => {
    ...
    axios.post("https://exclusiveserver.vercel.app/api/auth/verifyOTP",{otp,email})
        .then((result) => {
    ...
    const submitHandler2 = () => {
        ...
        if(validator())
        {
            ...
            {
                axios.put("https://exclusiveserver.vercel.app/api/auth/changePassword",{email , password})
                .then((result) => {
                    if(result.data == "Success")
                    {
                        setSeverity("success")
