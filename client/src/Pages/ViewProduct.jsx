...
const ViewProduct = () => {
    ...
    useEffect(() => {
      axios.get(`http://exclusiveserver-xr6s7fded-arshiks-projects.vercel.app/api/review/getReview/${id}`,config)
      .then((res) => {
    ...
    const sendReview = () => {
      axios.post(`http://exclusiveserver-xr6s7fded-arshiks-projects.vercel.app/api/review/addReview`, {id,message},config)
      .then((result) => {
