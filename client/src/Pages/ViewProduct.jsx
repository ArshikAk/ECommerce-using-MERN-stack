...
const ViewProduct = () => {
    ...
    useEffect(() => {
      axios.get(`https://exclusiveserver.vercel.app/api/product/getProducts`)
      .then((res) => {
    ...
    useEffect(() => {
      axios.get(`https://exclusiveserver.vercel.app/api/review/getReview/${id}`,config)
      .then((res) => {
    ...
    const sendReview = () => {
      axios.post(`https://exclusiveserver.vercel.app/api/review/addReview`, {id,message},config)
      .then((result) => {
