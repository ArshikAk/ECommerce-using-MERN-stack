...
const ProductCard = ({ product }) => {
  ...
  const addCart = () => {
    axios.post("https://exclusiveserver.vercel.app/api/cart/addCartItem",{product},config)
    .then((res) => {
      if(res.data == "Success")
      {
        setSeverity("success")
  ...
  const addWishList = () => {
    axios.post("https://exclusiveserver.vercel.app/api/wishList/addWishListItem",{product},config)
    .then((res) => {
      if(res.data == "Success")
      {
        setSeverity("success")
  ...
  const deleteWishListItem = () => {
    axios.delete(`https://exclusiveserver.vercel.app/api/wishList/deleteWishListItem/${product.productId}`,config)
    .then((res) => {
      if(res.data == "Success")
      {
        setSeverity("success")
